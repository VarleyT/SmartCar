...
const char OLED_FONT_CHN_LIBRARY[] = "温湿度";

const u8 OLED_FONT_CHN_MATRIX[] = {
        ...
        0x00, 0x60, 0x38, 0x04, 0x40, 0x46, 0x58, 0x40, 0x7E, 0x40, 0x40, 0x7E, 0x50, 0x58, 0x46, 0x00,/*"湿",1*/

        0x00, 0x00, 0xF8, 0x08, 0x48, 0x48, 0xF8, 0x48, 0x4E, 0x48, 0x48, 0xF8, 0x48, 0x48, 0x00, 0x00,
        0x00, 0x60, 0x3F, 0x00, 0x84, 0x44, 0x4D, 0x5D, 0x35, 0x25, 0x55, 0x4D, 0x44, 0x40, 0xC0, 0x00,/*"度",2*/};

const u8 OLED_ICON_WIFI_CONNECTED[] = {
        0x00, 0x60, 0x30, 0x98, 0xCC, 0x64, 0x24, 0x24, 0x24, 0x24, 0x64, 0xCC, 0x98, 0x30, 0x60, 0x00,
        0x00, 0x00, 0x00, 0x01, 0x00, 0x06, 0x03, 0x19, 0x19, 0x03, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00/*"WIFI已连接",0*/
};

const u8 OLED_ICON_WIFI_DISCONNECTED[] = {
        0x00, 0x60, 0x30, 0x98, 0xCC, 0x64, 0x24, 0x24, 0x24, 0x24, 0x64, 0xCC, 0x98, 0x30, 0x60, 0x00,
        0x00, 0x00, 0x00, 0x01, 0x00, 0x06, 0x53, 0x21, 0x21, 0x53, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00/*"WIFI未连接",1*/
};

const u8 OLED_ICON_TCP_CONNECTED[] = {
        0x00, 0x80, 0x40, 0x20, 0x00, 0x08, 0x04, 0x02, 0x82, 0x42, 0x02, 0x02, 0x04, 0x08, 0xF0, 0x00,
        0x00, 0x0F, 0x10, 0x20, 0x40, 0x40, 0x42, 0x41, 0x20, 0x10, 0x08, 0x00, 0x02, 0x01, 0x00, 0x00/*"TCP已连接",2*/
};

const u8 OLED_ICON_TCP_DISCONNECTED[] = {
        0x00, 0x00, 0x88, 0x50, 0x20, 0x40, 0x88, 0x04, 0x02, 0x02, 0x02, 0x02, 0x04, 0x08, 0xF0, 0x00,
        0x00, 0x0F, 0x10, 0x20, 0x40, 0x40, 0x40, 0x41, 0x22, 0x14, 0x08, 0x10, 0x22, 0x01, 0x00, 0x00/*"TCP未连接",3*/
};
